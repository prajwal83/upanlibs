...
enum opt_code
{
  ...
  OPT_march_ = 1086,                         /* -march= */
  OPT_masm_ = 1087,                          /* -masm= */
  OPT_mavx = 1088,                           /* -mavx */
  OPT_mavx2 = 1089,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1090,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1091,  /* -mavx256-split-unaligned-store */
  OPT_mavx512cd = 1092,                      /* -mavx512cd */
  OPT_mavx512er = 1093,                      /* -mavx512er */
  OPT_mavx512f = 1094,                       /* -mavx512f */
  OPT_mavx512pf = 1095,                      /* -mavx512pf */
  OPT_mbmi = 1096,                           /* -mbmi */
  OPT_mbmi2 = 1097,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1098,                  /* -mbranch-cost= */
  OPT_mcld = 1099,                           /* -mcld */
  OPT_mcmodel_ = 1100,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1101, */                    /* -mcpu= */
  OPT_mcrc32 = 1102,                         /* -mcrc32 */
  OPT_mcx16 = 1103,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1104,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1105,            /* -mdump-tune-features */
  OPT_mf16c = 1106,                          /* -mf16c */
  OPT_mfancy_math_387 = 1107,                /* -mfancy-math-387 */
  OPT_mfentry = 1108,                        /* -mfentry */
  OPT_mfma = 1109,                           /* -mfma */
  OPT_mfma4 = 1110,                          /* -mfma4 */
  OPT_mforce_drap = 1111,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1112,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1113,                       /* -mfpmath= */
  OPT_mfsgsbase = 1114,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1115, */              /* -mfused-madd */
  OPT_mfxsr = 1116,                          /* -mfxsr */
  OPT_mhard_float = 1117,                    /* -mhard-float */
  OPT_mhle = 1118,                           /* -mhle */
  OPT_mieee_fp = 1119,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1120,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1121,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1122,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1123, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1124,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1125,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1126,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1127,                /* -mlong-double-80 */
  OPT_mlwp = 1128,                           /* -mlwp */
  OPT_mlzcnt = 1129,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1130,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1131,              /* -mmemset-strategy= */
  OPT_mmmx = 1132,                           /* -mmmx */
  OPT_mmovbe = 1133,                         /* -mmovbe */
  OPT_mms_bitfields = 1134,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1135,            /* -mno-align-stringops */
  OPT_mno_default = 1136,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1137,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1138,                  /* -mno-push-args */
  OPT_mno_red_zone = 1139,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1140,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1141,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1142,                          /* -mpc32 */
  OPT_mpc64 = 1143,                          /* -mpc64 */
  OPT_mpc80 = 1144,                          /* -mpc80 */
  OPT_mpclmul = 1145,                        /* -mpclmul */
  OPT_mpopcnt = 1146,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1147,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1148,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1149,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1150,                        /* -mprfchw */
  OPT_mpush_args = 1151,                     /* -mpush-args */
  OPT_mrdrnd = 1152,                         /* -mrdrnd */
  OPT_mrdseed = 1153,                        /* -mrdseed */
  OPT_mrecip = 1154,                         /* -mrecip */
  OPT_mrecip_ = 1155,                        /* -mrecip= */
  OPT_mred_zone = 1156,                      /* -mred-zone */
  OPT_mregparm_ = 1157,                      /* -mregparm= */
  OPT_mrtd = 1158,                           /* -mrtd */
  OPT_mrtm = 1159,                           /* -mrtm */
  OPT_msahf = 1160,                          /* -msahf */
  OPT_msha = 1161,                           /* -msha */
  OPT_msoft_float = 1162,                    /* -msoft-float */
  OPT_msse = 1163,                           /* -msse */
  OPT_msse2 = 1164,                          /* -msse2 */
  OPT_msse2avx = 1165,                       /* -msse2avx */
  OPT_msse3 = 1166,                          /* -msse3 */
  OPT_msse4 = 1167,                          /* -msse4 */
  OPT_msse4_1 = 1168,                        /* -msse4.1 */
  OPT_msse4_2 = 1169,                        /* -msse4.2 */
  OPT_msse4a = 1170,                         /* -msse4a */
  /* OPT_msse5 = 1171, */                    /* -msse5 */
  OPT_msseregparm = 1172,                    /* -msseregparm */
  OPT_mssse3 = 1173,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1174,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1175,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1176,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1177,            /* -mstringop-strategy= */
  OPT_mtbm = 1178,                           /* -mtbm */
  OPT_mtls_dialect_ = 1179,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1180,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1181,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1182,                         /* -mtune= */
  OPT_mveclibabi_ = 1183,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1184,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1185,                    /* -mvzeroupper */
  OPT_mx32 = 1186,                           /* -mx32 */
  OPT_mxop = 1187,                           /* -mxop */
  OPT_mxsave = 1188,                         /* -mxsave */
  OPT_mxsaveopt = 1189,                      /* -mxsaveopt */
  OPT_n = 1190,                              /* -n */
  OPT_no_canonical_prefixes = 1191,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1192,              /* -no-integrated-cpp */
  OPT_nocpp = 1193,                          /* -nocpp */
  OPT_nodefaultlibs = 1194,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1195,                   /* -nostartfiles */
  OPT_nostdinc = 1196,                       /* -nostdinc */
  OPT_nostdinc__ = 1197,                     /* -nostdinc++ */
  OPT_nostdlib = 1198,                       /* -nostdlib */
  OPT_o = 1199,                              /* -o */
  OPT_p = 1200,                              /* -p */
  OPT_pass_exit_codes = 1201,                /* -pass-exit-codes */
  /* OPT_pedantic = 1202, */                 /* -pedantic */
  OPT_pedantic_errors = 1203,                /* -pedantic-errors */
  OPT_pg = 1204,                             /* -pg */
  OPT_pie = 1205,                            /* -pie */
  OPT_pipe = 1206,                           /* -pipe */
  OPT_print_file_name_ = 1207,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1208,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1209,          /* -print-multi-directory */
  OPT_print_multi_lib = 1210,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1211,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1212,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1213,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1214,               /* -print-prog-name= */
  OPT_print_search_dirs = 1215,              /* -print-search-dirs */
  OPT_print_sysroot = 1216,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1217,   /* -print-sysroot-headers-suffix */
  ...
  OPT_static_libstdc__ = 1236,               /* -static-libstdc++ */
  OPT_static_libtsan = 1237,                 /* -static-libtsan */
  OPT_static_libubsan = 1238,                /* -static-libubsan */
  /* OPT_std_c__03 = 1239, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1240, */                /* -std=c++0x */
  OPT_std_c__11 = 1241,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1242, */                /* -std=c++14 */
  OPT_std_c__1y = 1243,                      /* -std=c++1y */
  OPT_std_c__98 = 1244,                      /* -std=c++98 */
  OPT_std_c11 = 1245,                        /* -std=c11 */
  /* OPT_std_c1x = 1246, */                  /* -std=c1x */
  /* OPT_std_c89 = 1247, */                  /* -std=c89 */
  OPT_std_c90 = 1248,                        /* -std=c90 */
  OPT_std_c99 = 1249,                        /* -std=c99 */
  /* OPT_std_c9x = 1250, */                  /* -std=c9x */
  OPT_std_f2003 = 1251,                      /* -std=f2003 */
  OPT_std_f2008 = 1252,                      /* -std=f2008 */
  OPT_std_f2008ts = 1253,                    /* -std=f2008ts */
  OPT_std_f95 = 1254,                        /* -std=f95 */
  OPT_std_gnu = 1255,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1256, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1257, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1258,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1259, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1260,                    /* -std=gnu++1y */
