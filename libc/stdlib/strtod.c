...
float strtof(const Wchar *str, Wchar **endptr)
{
#if FPMAX_TYPE == 1
...
double strtod(const Wchar *__restrict str, Wchar **__restrict endptr)
{
#if FPMAX_TYPE == 2
	return __strtofpmax(str, endptr, 0) ;
#else
...
#define Wchar char
long double strtold(const Wchar *str, Wchar **endptr)
{
#if FPMAX_TYPE == 3
	return __strtofpmax(str, endptr, 0) ;
#else
