...
#ifndef L___scan_cookie
#define  L___scan_cookie
#endif

#ifndef L__ppfs_setargs
#define  L__ppfs_setargs
#endif

#ifndef L__ppfs_prepargs
#define  L__ppfs_prepargs
#endif

#ifndef L__ppfs_parsespec
#define  L__ppfs_parsespec
#endif

#ifndef L___psfs_do_numeric
...
#define GETC(SC) (((SC)->fp) ? getc_unlocked((SC)->fp) : getc_scanf(SC))
#endif /* __UCLIBC_HAS_WCHAR__ */
#endif

extern int vfscanf (FILE *__restrict fp, const Wchar *__restrict format, va_list arg) ;

extern ssize_t __getdelim(char **__restrict lineptr, size_t *__restrict n,
