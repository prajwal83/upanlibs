...
extern FILE *open_memstream(char **__restrict bufloc, size_t *__restrict sizeloc) ;
extern int VFPRINTF (FILE * __restrict stream, register const FMT_TYPE * __restrict format, va_list arg) ;

int vasprintf(char **__restrict buf, const char * __restrict format, va_list arg)
{
